...
const clientSchema = new mongoose.Schema(
  {
    acronym: {
      ...
      trim: true,
      uppercase: true, // Para manter sempre maiúsculo
      maxlength: [10, 'Acronym must have maximum 10 characters'],
      minlength: [2, 'Acronym must have minimum 2 characters']
    },
    ...
    contact: {
      responsibleName: {
        type: String,
        required: [true, 'Responsible name is required'],
        trim: true,
        maxlength: [100, 'Responsible name must have maximum 100 characters']
      },
      phone: {
        type: String,
